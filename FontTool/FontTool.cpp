...
//DestPath Face Size Bold(bool) Italic(bool)
	...
	bool VSFontTool::OnInitial()
	{
		...
		if (m_pCommand)
		{
			...
			VSResourceManager::SaveResouce(m_pFont, m_sPathName.GetBuffer(),true);
			DestroyWindow(hWnd);
	...
	void VSFontTool::CreateFontData(HDC hDC)
	{
		...
		VSREAL characterData[VSFont::ASCII_NUM + 1];
