...
//#define  TYPE_ADD_TO_UI
	...
	template<> struct TIsVSRealType<VSREAL> { enum { Value = true }; };
...
public:
	...
	template<> inline VSEditorElement * CreateEElement<VSVector3>(VSVector3& Value, VSString & Name, VSObject * pOwner, bool bRange, VSVector3 & Max, VSVector3 & Min, VSVector3& fStep)
	{
...
#ifdef TYPE_ADD_TO_UI
	template<> inline VSEditorElement * CreateEElement<unsigned int>(unsigned int& Value, VSString & Name, VSObject * pOwner, bool bRange, unsigned int & Max, unsigned int & Min, unsigned int& fStep)
	{
		return VS_NEW VSValueProperty<unsigned int>(&Value, Name, pOwner, bRange, Max, Min, fStep);
	}
	template<> inline VSEditorElement * CreateEElement<int>(int& Value, VSString & Name, VSObject * pOwner, bool bRange, int & Max, int & Min, int& fStep)
	{
	...
	template<> inline VSEditorElement * CreateEElement<TCHAR>(TCHAR& Value, VSString & Name, VSObject * pOwner, bool bRange, TCHAR & Max, TCHAR & Min, TCHAR & fStep)
	{
		return VS_NEW VSValueProperty<TCHAR>(&Value, Name, pOwner, bRange, Max, Min, fStep);
	}
	template<> inline VSEditorElement * CreateEElement<VSREAL>(VSREAL& Value, VSString & Name, VSObject * pOwner, bool bRange, VSREAL & Max, VSREAL & Min, VSREAL & fStep)
	{
