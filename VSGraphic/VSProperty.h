...
namespace VSEngine2
{
	...
	public:
		...
		inline bool AddElement(void* pObj,unsigned int uiIndex,MapElement<KEY,VALUE>& pDataSrc)
		{
			GetContainer(pObj).AddElement(pDataSrc);
			return true;
		}
	...
	struct AutoPropertyCreator<VSArray<T,VSMemManagerClass>>
	{
		VSProperty* CreateProperty(const VSUsedName & Name, VSRtti & Owner, unsigned int Offset,unsigned int uiFlag)
		{
			...
			return VS_NEW VSArrayProperty<VSArray<T,VSMemManagerClass>,T>(Owner, Name,Offset,uiFlag);
		...
		VSProperty* CreateProperty(const VSUsedName & Name, VSRtti & Owner, unsigned int Offset,T HighValue ,T LowValue,T fStep,unsigned int uiFlag)
		{
			...
			return VS_NEW VSArrayProperty<VSArray<T, VSMemManagerClass>, T>(Owner, Name, Offset, uiFlag, HighValue, LowValue, fStep);
	...
	struct AutoPropertyCreator<VSArrayOrder<T,VSMemManagerClass>>
	{
		VSProperty* CreateProperty(const VSUsedName & Name, VSRtti & Owner, unsigned int Offset,unsigned int uiFlag)
		{
			...
			return VS_NEW VSArrayProperty<VSArrayOrder<T,VSMemManagerClass>,T>(Owner, Name,Offset,uiFlag);
		}
		VSProperty* CreateFunctionProperty(const VSUsedName & Name, VSFunction & Owner, unsigned int Offset, unsigned int uiFlag)
		{
		...
		VSProperty* CreateProperty(const VSUsedName & Name, VSRtti & Owner, unsigned int Offset,T HighValue ,T LowValue,VSREAL fStep,unsigned int uiFlag)
		{
			...
			return VS_NEW VSArrayProperty<VSArrayOrder<T, VSMemManagerClass>, T>(Owner, Name, Offset, uiFlag, HighValue, LowValue, fStep);
	...
	struct AutoPropertyCreator<VSMap<KEY,VALUE,VSMemManagerClass>>
	{
		VSProperty* CreateProperty(const VSUsedName & Name, VSRtti & Owner, unsigned int Offset,unsigned int uiFlag)
		{
			...
			return VS_NEW VSMapProperty<VSMap<KEY,VALUE,VSMemManagerClass>,KEY,VALUE>(Owner, Name,Offset,uiFlag);
		...
		VSProperty* CreateProperty(const VSUsedName & Name, VSRtti & Owner, unsigned int Offset,VALUE HighValue ,VALUE LowValue,VSREAL fStep,unsigned int uiFlag)
		{
			...
			return VS_NEW VSMapProperty<VSMap<KEY, VALUE, VSMemManagerClass>, KEY, VALUE>(Owner, Name, Offset, uiFlag, HighValue, LowValue, fStep);
	...
	struct AutoPropertyCreator<VSMapOrder<KEY,VALUE,VSMemManagerClass>>
	{
		VSProperty* CreateProperty(const VSUsedName & Name,VSRtti & Owner, unsigned int Offset,unsigned int uiFlag)
		{
			...
			return VS_NEW VSMapProperty<VSMapOrder<KEY,VALUE,VSMemManagerClass>,KEY,VALUE>(Owner, Name,Offset,uiFlag);
		...
		VSProperty* CreateProperty(const VSUsedName & Name,VSRtti & Owner, unsigned int Offset,VALUE HighValue ,VALUE LowValue,VSREAL fStep,unsigned int uiFlag)
		{
			...
			return VS_NEW VSMapProperty<VSMapOrder<KEY, VALUE, VSMemManagerClass>, KEY, VALUE>(Owner, Name, Offset, uiFlag, HighValue, LowValue, fStep);
