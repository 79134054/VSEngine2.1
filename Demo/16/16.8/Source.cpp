...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	m_pCameraActor->GetTypeNode()->m_bEnableStreamResource = true;
	m_pTestMap = VSWorld::ms_pWorld->CreateScene(_T("Test"));

	VSWorld::ms_pWorld->CreateActor(_T("NewStone.STMODEL"),VSVector3(0.0f,0.0f,400.0f),VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);

	VSWorld::ms_pWorld->CreateActor(_T("NewStone.STMODEL"), VSVector3(0.0f, 0.0f, 800.0f), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
