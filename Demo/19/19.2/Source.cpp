...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSStaticActor* pStaticActor = (VSStaticActor*)VSWorld::ms_pWorld->CreateActor(_T("TessellationOceanPlane.STMODEL"), VSVector3(0, 0, 0), VSMatrix3X3::ms_Identity, VSVector3(100.0f, 100.f, 100.0f), m_pTestMap);
	pStaticActor->GetTypeNode()->CastShadow(true);
	...
	VSMatrix3X3 Dir;
	Dir.CreateEuler(0, AngleToRadian(30), AngleToRadian(0));
...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(300, 640, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key 'W' to Show tessellation and displacement Wireless"));
	return true;
}
