...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSSkeletonActor * pSKActor1 = (VSSkeletonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterBlinnPhone.SKMODEL"), VSVector3(0, 0, 0), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
...
bool VSDemoWindowsApplication::PostUpdate()
{
	...
	pMaterialInstance0->SetShaderValue(_T("SpecularPow"), &SpecularPow0, sizeof(SpecularPow0));
	pMaterialInstance1->SetShaderValue(_T("SpecularPow"), &SpecularPow1, sizeof(SpecularPow1));
	return true;
}
...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(300, 640, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key '+' And '-' to Change SpecularPow0"));
	VSRenderer::ms_pRenderer->DrawText(300, 660, VSDWCOLORABGR(255, 255, 255, 255), _T("SpecularPow0:%f"), SpecularPow0);
	VSRenderer::ms_pRenderer->DrawText(300, 680, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key '[' And ']' to Change SpecularPow1"));
	VSRenderer::ms_pRenderer->DrawText(300, 700, VSDWCOLORABGR(255, 255, 255, 255), _T("SpecularPow1:%f"), SpecularPow1);
	return true;
}
