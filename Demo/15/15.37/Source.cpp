...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSSkeletonActor * pSKActor1 = (VSSkeletonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(-300, 0, 300), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	pSKActor1->GetTypeNode()->PlayAnim(_T("Idle"), 1.0f, VSController::RT_WRAP);

	VSSkeletonActor * pSKActor2 = (VSSkeletonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(0, 0, 300), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	pSKActor2->GetTypeNode()->PlayAnim(_T("Walk"), 1.0f, VSController::RT_WRAP);

	VSSkeletonActor * pSKActor3 = (VSSkeletonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(300, 0, 300), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	pSKActor3->GetTypeNode()->PlayAnim(_T("Attack"), 1.0f, VSController::RT_WRAP);

	VSSkeletonActor * pSKActor4 = (VSSkeletonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(-300, 0,-300), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	...
	VSSkeletonActor * pSKActor6 = (VSSkeletonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(300, 0, -300), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	...
	pSkyLightActor->GetTypeNode()->m_DownColor = VSColorRGBA(0.0f, 0.0f, 0.1f, 1.0f);
	pSkyLightActor->GetTypeNode()->m_UpColor = VSColorRGBA(0.1f, 0.1f, 0.1f, 1.0f);

	VSMaterialRPtr  pLightFun = VSResourceManager::LoadASYNResource<VSMaterial>(_T("LightFunction.MATERIAL"), false);
	...
	VSPointLightActor * pPointLightActor = (VSPointLightActor*)VSWorld::ms_pWorld->CreateActor<VSPointLightActor>(VSVector3(0.0f, 200.0f, -700.0f), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
