...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSSkeletonActor * pSkActor = (VSSkeletonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonster.SKMODEL"), VSVector3(0, 0, 0), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	pSkActor->GetTypeNode()->SetIsDrawSkeleton(true);
