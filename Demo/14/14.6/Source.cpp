...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSSkeletonActor * pSKActor3 = (VSSkeletonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithSocket.SKMODEL"), VSVector3(0, 0, 800), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
