...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSVector3 CameraPos(0.0f, 20.0f, -1200.0f);
	...
	VSRootMotionActor * pMonsterActor2 = (VSRootMotionActor *)VSWorld::ms_pWorld->CreateActor<VSRootMotionActor>(VSVector3(0, 0, 0), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(0, 700, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key 'P' to move again"));
