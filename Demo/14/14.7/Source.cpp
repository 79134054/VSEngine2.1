...
namespace VSEngine2
{
	...
	bool MaterialSaverDemo::OnInitial()
	{
		...
		VSAnimTreeOneAnimPtr  pAnimTreeOneAnim = VS_NEW VSAnimTreeOneAnim(_T("AnimTreeOneAnim"), _T("Walk"));


		VSOutputDebugString("Save VSEngine AnimTree AnimTreeOneAnim\n");
		printf("Save VSEngine AnimTree AnimTreeOneAnim\n");
		VSResourceManager::SaveResouce(pAnimTreeOneAnim, _T("AnimTreeOneAnim"), true);
