...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSSkeletonActor * pSKActor4 = (VSSkeletonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithPartialAnim1.SKMODEL"), VSVector3(1200, 0, 1400), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	VSSkeletonActor * pSKActor1 = (VSSkeletonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithPartialAnim2.SKMODEL"), VSVector3(600, 0, 1400), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
