...
namespace VSEngine2
{
	...
	bool MaterialSaverDemo::OnInitial()
	{
		...
		VSResourceManager::SaveResouce(pAnimTreePartialAnim1, _T("AnimTreePartialAnim1"), true);
		...
		VSResourceManager::SaveResouce(pAnimTreePartialAnim2, _T("AnimTreePartialAnim2"), true);
