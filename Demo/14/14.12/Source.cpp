...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	pSKActor3 = (VSSkeletonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithTwoSmoothBlendAnim.SKMODEL"), VSVector3(0, 0, 300), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(300, 640, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key '+' And '-' to Change SmoothAnimBlendParamter"));
	VSRenderer::ms_pRenderer->DrawText(300, 660, VSDWCOLORABGR(255, 255, 255, 255), _T("SmoothAnimBlendParamter:%f"), m_fPencent);
	return true;
}
