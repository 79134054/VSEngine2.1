...
void VSMonsterActor1::CreateDefaultComponentNode()
{
	...
	VSSkeletonMeshNodeRPtr pResource = VSResourceManager::LoadASYNResource<VSSkeletonMeshNode>(_T("AnimTreeMonster1.SKMODEL"), false);
	...
	m_pViewFamily = VS_NEW VSWindowViewFamily(_T("WindowUse"), m_pThirdCamera, NULL, VSForwardEffectSceneRenderMethod::ms_Type.GetName().GetBuffer(), -1);
