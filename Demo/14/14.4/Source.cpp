//加载14.3导出的模型并渲染，循环播放6个动画，第5个为叠加动画，第6个位pos
...
bool VSDemoWindowsApplication::OnInitial()
{
	...
	VSSkeletonActor * pSKActor1 = (VSSkeletonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(-1200, 0, 1400), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	//pSKActor1->GetTypeNode()->SetIsDrawSkeleton(true);
	pSKActor1->GetTypeNode()->SetIsDrawBoundVolume(true);
	pSKActor1->GetTypeNode()->PlayAnim(_T("Idle"), 1.0f, VSController::RT_WRAP);

	VSSkeletonActor * pSKActor2 = (VSSkeletonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(-600, 0, 1400), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	//pSKActor2->GetTypeNode()->SetIsDrawSkeleton(true);
	pSKActor2->GetTypeNode()->SetIsDrawBoundVolume(true);
	pSKActor2->GetTypeNode()->PlayAnim(_T("Walk"), 1.0f, VSController::RT_WRAP);

	VSSkeletonActor * pSKActor3 = (VSSkeletonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(0, 0, 1400), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	//pSKActor3->GetTypeNode()->SetIsDrawSkeleton(true);
	pSKActor3->GetTypeNode()->SetIsDrawBoundVolume(true);
	pSKActor3->GetTypeNode()->PlayAnim(_T("Attack"), 1.0f, VSController::RT_WRAP);

	VSSkeletonActor * pSKActor4 = (VSSkeletonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(600, 0, 1400), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	//pSKActor4->GetTypeNode()->SetIsDrawSkeleton(true);
	pSKActor4->GetTypeNode()->SetIsDrawBoundVolume(true);
	pSKActor4->GetTypeNode()->PlayAnim(_T("Attack2"), 1.0f, VSController::RT_WRAP);


	VSSkeletonActor * pSKActor5 = (VSSkeletonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(1200, 0, 1400), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	//pSKActor5->GetTypeNode()->SetIsDrawSkeleton(true);
	pSKActor5->GetTypeNode()->SetIsDrawBoundVolume(true);
	pSKActor5->GetTypeNode()->PlayAnim(_T("Pos"), 1.0f, VSController::RT_WRAP);

	VSSkeletonActor * pSKActor6 = (VSSkeletonActor *)VSWorld::ms_pWorld->CreateActor(_T("NewMonsterWithAnim.SKMODEL"), VSVector3(1800, 0, 1400), VSMatrix3X3::ms_Identity, VSVector3::ms_One, m_pTestMap);
	//pSKActor6->GetTypeNode()->SetIsDrawSkeleton(true);
