...
bool VSDemoWindowsApplication::OnDraw()
{
	...
	VSRenderer::ms_pRenderer->DrawText(300, 640, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key 'Left' And 'Right' or Put Down Left Mouse Button to Change Direction"));
	VSRenderer::ms_pRenderer->DrawText(300, 660, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key 'Up' to Move"));
	VSRenderer::ms_pRenderer->DrawText(300, 680, VSDWCOLORABGR(255, 255, 255, 255), _T("Use Key 'A' to Attack"));
	return true;
}
