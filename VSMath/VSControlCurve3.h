...
public:
	...
	/***************************************inline************************************/
	//得到控制点指针
	inline const VSVector3 * GetpControlPoint()const;
	//获得某个控制点
	inline VSVector3 GetControlPoint(unsigned int i)const;
	//改变某个控制点
	inline bool ChangeControlPoint(unsigned int i,const VSVector3 & ControlPoint);
	//得到控制点个数
