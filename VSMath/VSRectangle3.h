...
public:	
	...
	/*************************************inline************************************************/
	inline void Set(const VSVector3 & Center,const VSVector3 &A0,const VSVector3 & A1,VSREAL fA0, VSREAL fA1);
	inline void Set(const VSVector3 & Center,const VSVector3 A[2],const VSREAL fA[2]);
	inline void GetA(VSVector3 A[2])const;
	inline void GetfA(VSREAL fA[2])const;
	inline const VSVector3 & GetCenter()const;
	inline void GetPoint(VSVector3 Point[4])const;
	inline VSVector3 GetParameterPoint(VSREAL fRectangleParameter[2])const;
	inline VSVector3 GetParameterPoint(VSREAL fRectangleParameter0,VSREAL fRectangleParameter1)const;
	/*************************************距离************************************************/
	//点和矩形距离
