...
class VSSegment3;
	...
	public:	
		...
		/*********************************** inline *************************************/
		inline void Set(const VSVector3 A[3],VSREAL fA[3],const VSVector3 & Center);
		inline void Set(const VSVector3 &A0,const VSVector3 &A1,const VSVector3 &A2,
						VSREAL fA0,VSREAL fA1,VSREAL fA2,
						const VSVector3 & Center);
		
		inline void GetA(VSVector3 A[3])const;
		inline void GetfA(VSREAL fA[3])const;
		inline const VSVector3 & GetCenter()const;
		//根据参数返回点
		inline VSVector3 GetParameterPoint(VSREAL fOBBParameter[3])const;
		inline VSVector3 GetParameterPoint(VSREAL fOBBParameter0,VSREAL fOBBParameter1,VSREAL fOBBParameter2)const;
