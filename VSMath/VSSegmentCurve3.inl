inline void VSSegmentCurve3::GetFrenetFrameBNT(VSREAL t,VSVector3 & B,VSVector3 & N,VSVector3 &T)
{
	VSCurve3::GetFixedUpBNT(t,B,N,T);
}
/*----------------------------------------------------------------*/
inline VSVector3	VSSegmentCurve3::GetFirstDerivative(VSREAL t)
{

	return m_Segment.GetDir() * m_Segment.GetLen();
}
/*----------------------------------------------------------------*/
inline VSVector3	VSSegmentCurve3::GetSecondDerivative(VSREAL t)
{
	return VSVector3(0,0,0);
}
/*----------------------------------------------------------------*/
inline VSVector3	VSSegmentCurve3::GetThirdDerivative(VSREAL t)
{
...
/*----------------------------------------------------------------*/
inline VSVector3	VSSegmentCurve3::GetPoint(VSREAL t)
{
