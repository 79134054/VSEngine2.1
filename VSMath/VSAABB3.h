...
namespace VSEngine2
{
	...
	public:
		...
		/*********************************** inline *************************************/
		//设置相应的参数
		inline void Set(const VSVector3 & Max , const VSVector3 & Min);
		inline void Set(const VSVector3 & Center,VSREAL fA0,VSREAL fA1,VSREAL fA2);
		inline void Set(const VSVector3 & Center,VSREAL fA[3]);
		//获取相应的参数
		inline void GetfA(VSREAL fA[3])const;
		inline const VSVector3 & GetCenter()const;
		inline VSVector3 GetParameterPoint(VSREAL fAABBParameter[3])const;
		inline VSVector3 GetParameterPoint(VSREAL fAABBParameter0,VSREAL fAABBParameter1,VSREAL fAABBParameter2)const;
		inline const VSVector3 & GetMaxPoint()const;
		inline const VSVector3 & GetMinPoint()const;
		//得到AABB6个平面
