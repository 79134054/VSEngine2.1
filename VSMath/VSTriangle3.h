...
namespace VSEngine2
{
	...
	public:
		...
		inline void Set(const VSVector3 & P1,const VSVector3 &P2,const VSVector3 &P3);
		inline void Set(const VSVector3 Point[3]);
		inline void GetPoint(VSVector3  Point[3])const;
		inline VSVector3 GetParameterPoint(VSREAL fTriangleParameter[3])const;
		inline VSVector3 GetParameterPoint(VSREAL fTriangleParameter0,
